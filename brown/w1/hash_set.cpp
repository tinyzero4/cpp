...
public:
    explicit HashSet(size_t num_buckets, const Hasher& hasher = {}): buckets(vector<BucketList>(num_buckets)), hasher(hasher) {}

    void Add(const Type& value) {
        BucketList &list = buckets[hasher(value) % buckets.size()];
    ...
    bool Has(const Type& value) const {
        const BucketList &list = buckets[hasher(value) % buckets.size()];
